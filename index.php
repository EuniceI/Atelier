...
<body>
    ...
    <!-- 동영상 배경 -->
    <div class="video-bg">
        <video src="./media/galaxy_1.mp4" autoplay muted playsinline="playsinline" poster="./imgs/main-bg1.jpg" ></video>
    </div>
    <div class="video-bg hide">
        <video src="./media/galaxy_2.mp4" autoplay muted playsinline="playsinline" poster="./imgs/main-bg2.jpg"  ></video>
    </div>
    <div class="video-bg hide">
        <video src="./media/galaxy_3.mp4" autoplay muted playsinline="playsinline" poster="./imgs/main-bg3.jpg"  ></video>
    </div>
    <div class="video-bg hide">
        <video src="./media/galaxy_4.mp4"autoplay muted playsinline="playsinline" poster="./imgs/main-bg4.jpg"  ></video>
    </div>
